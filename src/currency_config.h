...
#define CURRENCY_BLOCK_FUTURE_TIME_LIMIT                7200 // (60*60*2)
#define CURRENCY_POS_BLOCK_FUTURE_TIME_LIMIT            1200 // (60*20)
...
#define CURRENCY_BLOCKS_PER_DAY                         (7200/(DIFFICULTY_TOTAL_TARGET)) // ((60*60*24)/(DIFFICULTY_TOTAL_TARGET))
